...
links-own [
  players-ready ;; counter to keep track of whether both players at the ends of this link are ready
...
;; Procedure to match all the prisoners. Asks all unpartnered turtles to find another unpartnered turtle and make a link.
to match-prisoners
